...
INIT_TANK_LEVEL = 0
INIT_EMERGENCY_STOP = 0
INIT_PUMP_SWITCH = 0
INIT_PUMP_STATUS = 0
INIT_INFLOW_VALVE = 0
INIT_OUTFLOW_VALVE = 0
INIT_INFLOW_RATE = 0
INIT_OUTFLOW_RATE = 0
INIT_INFLOW_MODE = 0
INIT_OVERFLOW_ALARM = 0
...
def setup_modbus_server():
    holding_register_values = [
        INIT_TANK_LEVEL, INIT_EMERGENCY_STOP, INIT_PUMP_SWITCH, INIT_PUMP_STATUS,
        INIT_INFLOW_VALVE, INIT_OUTFLOW_VALVE, INIT_INFLOW_RATE, 
        INIT_OUTFLOW_RATE, INIT_INFLOW_MODE, INIT_OVERFLOW_ALARM
    ]
    
    coil_values = [
        INIT_EMERGENCY_STOP, INIT_PUMP_SWITCH, INIT_PUMP_STATUS,
        INIT_INFLOW_VALVE, INIT_OUTFLOW_VALVE, INIT_INFLOW_MODE, INIT_OVERFLOW_ALARM,
        0, 0
    ]
