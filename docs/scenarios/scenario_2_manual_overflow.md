...
| `modbus.write_coil.value` | Coil value to write | string | `ON` |
...
|---|---:|---|
| PumpSwitch | Coil `1` | `ON` |
| InflowMode / Manual mode | Coil `5` | `ON` |
...
| 2 | Modbus - Write Single Coil | `056e6289-4cbf-417f-928a-d75125e4db4f` | `start=1`, `value=ON` |
| 3 | Modbus - Write Single Coil | `056e6289-4cbf-417f-928a-d75125e4db4f` | `start=5`, `value=ON` |
...
| `bacnet.write.value` | Value to write | string | `1`, `900`, or `50` |
